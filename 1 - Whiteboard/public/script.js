...
// GET IMAGE IN NEW TAB

function getimg() {
    var dataURL = canvas.toDataURL();
    console.log(dataURL); //print the url of the image in the console if there is a problem opening in the new tab with Chrome for example
    const newtab = window.open("");
    //newtab.document.title = "Your image";
    newtab.document.write(`<img src = "${dataURL}"/>`);
    newtab.stop(); //stop the page of loading infinitely
